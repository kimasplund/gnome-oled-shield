...
export default class EventEmitter extends GObject.Object {
    ...
    #cleanupTimerId = null;
    #abortHandlerIds = new Map();  // For tracking abort handler IDs in Wayland
        ...
        if (options.signal instanceof AbortSignal) {
            ...
            if (IS_WAYLAND) {
                ...
                abortHandler = () => {
                    try {
                        ...
                        this.#abortListeners.delete(key);
                        this.#abortHandlerIds.delete(key);
                    }
                };
            } else {
            ...
            try {
                ...
                if (IS_WAYLAND && SESSION_CONFIG.useStrongReferences) {
                    this.#abortHandlerIds.set(key, { signal, handler: abortHandler });
                }
            } catch (error) {
    ...
    destroy() {
        ...
        // Emit destroyed event BEFORE removing listeners so they can respond
