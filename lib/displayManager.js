...
export default class DisplayManager extends EventEmitter {
    ...
    constructor(settings) {
        ...
        this.#protectedDisplays = new Map();
        this.#displaySelectorDialog = null;
        ...
        this.#displayTypes = new Map();
        this.#brightnessLevels = new Map();
        this.#contrastLevels = new Map();
        ...
        try {
            ...
            this.#monitorManager = global.backend.get_monitor_manager?.() ?? Meta.MonitorManager.get();
